...
COMMENT ON COLUMN  "mtc_alarm"."machine_type" IS '机器类型,(1,主机)';
...
CREATE TABLE  "mtc_db_info" (
            ...
            "driver_name" varchar(128) COLLATE "pg_catalog"."default",
            "db_type" varchar(128) COLLATE "pg_catalog"."default",
            "driver_url" varchar(128) COLLATE "pg_catalog"."default",
            "username" varchar(128) COLLATE "pg_catalog"."default",
            "password" varchar(128) COLLATE "pg_catalog"."default",
            "test_SQL" varchar(128) COLLATE "pg_catalog"."default",
            "is_open" int2
);

COMMENT ON COLUMN  "mtc_db_info"."name" IS '数据库名称';
COMMENT ON COLUMN  "mtc_db_info"."driver_name" IS '驱动名称';
COMMENT ON COLUMN  "mtc_db_info"."db_type" IS '数据库类型';
COMMENT ON COLUMN  "mtc_db_info"."driver_url" IS '连接字符串';
COMMENT ON COLUMN  "mtc_db_info"."username" IS '用户名称';
COMMENT ON COLUMN  "mtc_db_info"."password" IS '用户密码';
COMMENT ON COLUMN  "mtc_db_info"."test_SQL" IS '测试SQL';
COMMENT ON COLUMN  "mtc_db_info"."is_open" IS '是否开启(1.开启,0关闭)';
...
CREATE TABLE  "mtc_graphics" (
             ...
             "width" varchar(128) COLLATE "pg_catalog"."default",
             "height" varchar(128) COLLATE "pg_catalog"."default",
             "host_id" varchar(128) COLLATE "pg_catalog"."default",
             "source" int2
)
;
...
-- ----------------------------
-- Table structure for mtc_role
-- ----------------------------
CREATE TABLE  "mtc_role" (
             "id" int4 NOT NULL,
             "name" varchar(128) COLLATE "pg_catalog"."default",
             "type" int2
)
;
COMMENT ON COLUMN  "mtc_role"."id" IS '角色（权限）表的id';
COMMENT ON COLUMN  "mtc_role"."name" IS '角色名称';
COMMENT ON COLUMN  "mtc_role"."type" IS '权限类型';
COMMENT ON TABLE  "mtc_role" IS '角色权限表';
...
-- ----------------------------
-- Primary Key structure for table mtc_role
-- ----------------------------
ALTER TABLE  "mtc_role" ADD CONSTRAINT "roles_pkey" PRIMARY KEY ("id");
