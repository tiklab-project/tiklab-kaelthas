...
class InternetTests {
    ...
    void contextLoads() throws IOException {
        ...
        System.out.println("获取容器信息：" + GetMessage.getMessageByIpAndOid("172.10.1.1", MySnmp.Sys_Desc));
        System.out.println("获取容器名称：" + GetMessage.getMessageByIpAndOid("172.10.1.1", MySnmp.Sys_Name));
        System.out.println("获取容器开启时长：" + GetMessage.getMessageByIpAndOid("172.10.1.1", MySnmp.Sys_Up_Time));
