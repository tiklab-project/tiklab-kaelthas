package io.tiklab.kaelthas.kubernetes.agent.service;
...
import io.tiklab.kaelthas.kubernetes.agent.common.NodeItem;
import io.tiklab.kaelthas.kubernetes.agent.common.ServiceItem;
import io.tiklab.kaelthas.kubernetes.agent.common.ConversionAllTypeUtil;
...
public class GetKuReportData {
   ...
   // @Scheduled(cron = "0 0/1 * * * ? ")
    ...
    private static KubernetesHistory getHistory(KuMonitor kuMonitor) {
        ...
        KubernetesHistory history = new KubernetesHistory();
        history.setKuId(kuMonitor.getKuId());
        history.setKuMonitorId(kuMonitor.getId());
